...
/**
 * Class SuperAdminBackendControllerTest
 */
class SuperAdminBackendControllerTest extends WebTestCase
{
    /**
...
//            array('/admin/windfarms/windfarm/1/pdf'),
            ...
            array('/admin/workorders/repair/list'),
            array('/admin/workorders/repair/create'),
            array('/admin/workorders/repair/1/edit'),
            array('/admin/workorders/repair/1/delete'),
     ...
     * @param string $url
     */
    public function testAdminPagesAreForbiddenOrNotFound($url)
    {
        $client = $this->getAuthenticatedClient();
        $client->request('GET', $url);
    ...
    public function provideAdminPagesForNotFoundUrls()
    {
        return array(
            ...
            array('/admin/workorders/repair/batch'),
            array('/admin/workorders/repair/1/show'),
    ...
    {
        return static::createClient([], [     // authenticated user with ROLE_SUPER_ADMIN
            'PHP_AUTH_USER' => 'test1',
